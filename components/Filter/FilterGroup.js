...
const FilterGroup = ({ toggable = true, visible = false, buttonRight = true, filterRight = false, children }) => {
    ...
    return (
        <div className={styles['filter-group']}>
            ...
            <div className={cn(styles['filters'], showFilters ? styles['visible'] : styles['hidden'], filterRight ? styles['right'] : undefined)}>
                {children}
            </div>
        </div>
    );
